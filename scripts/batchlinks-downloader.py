...
try:
    ...
    if platform.system() == "Windows":
        ...
        script_path = os.path.join(downloadpath, "neko-colab")
    elif platform.system() == "Darwin":
        userhome = os.environ['HOME']
        downloadpath = os.path.join(userhome, "Downloads")
        script_path = os.path.join(downloadpath, "neko-colab")
    else:
        script_path = '/content/drive/MyDrive/neko-colab'
...
try:
    versionurl = "https://raw.githubusercontent.com/shinobu254/batchlinks-startfk/main/version.txt"
...
modelpath = os.path.join(script_path, "models/Neko-model")
...
addnetlorapath = os.path.join(script_path, "extensions/startfk-additional-networks/models/lora")
hynetpath = os.path.join(script_path, "models/hypernetworks")
aestheticembedpath = os.path.join(script_path, "extensions/startfk-aesthetic-gradients/aesthetic_embeddings")
cnetpath = os.path.join(script_path, "extensions/startfk-controlnet/models")
...
def run(command, choosedowner, civitdefault, civitpruned, civitvae, progress=gr.Progress()):
    ...
    if cmd_opts.ckpt_dir:
        ...
        altmodelpath = os.path.join(models_path, "Neko-model")
        currentfolder = modelpath
...
introductiontext = f"""
{titletext}
<h5 style="display: inline-block; font-size: 14px;"><u><a href="https://github.com/shinobu254/batchlinks-startfk/blob/main/releasenotes.md" target="_blank">(what's new?)</a></u></h5>
...
(For colab that uses startfk-additional-networks extension to load LoRA, use <code>#addnetlora</code> instead)<br/>
...
<u><a href="https://github.com/shinobu254/batchlinks-startfk">Readme Page</a></u><br/>
<u><a href="https://github.com/shinobu254/batchlinks-startfk/wiki/Usage-Example">Example</a></u><br/>
<u><a href="https://github.com/shinobu254/batchlinks-startfk/wiki/Main-Syntax">Syntax</a></u><br/>
<u><a href="https://github.com/shinobu254/batchlinks-startfk/wiki/Valid-Hashtags">Valid Hashtags</a></u><br/>
<u><a href="https://github.com/shinobu254/batchlinks-startfk/blob/main/howtogetthedirectlinks.md">Here's how you can get the direct links</a></u><br/>
<u><a href="https://github.com/shinobu254/batchlinks-startfk/issues">Report Bug</a></u></p>
"""
          ...
          with gr.Row():
            with gr.Box():
                if gradiostate == True:
                    ...
                    if vladmandic:
                        print("Batchlinks startfk extension: (Optional) Remove the --disable-queue args to enable logging & cancel button on this extension")
                    else:
                        print("Batchlinks startfk extension: (Optional) Use --gradio-queue args to enable logging & cancel button on this extension")
